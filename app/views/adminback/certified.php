    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <table class="table">
            <thead>
              <tr>
                <th>Certified_Title</th>
                <th>Certified_Image</th>
                <th>Delete</th>
                <th>Update</th>
              </tr>
            </thead>
            <tbody>
              <?php foreach($certfidata as $c):  ?>
              <tr>
                <td><?=  $c['cert_tit']; ?></td>
                <td><img src="<?= Domain_Path; ?>images/<?= $c['cert_img']; ?>" width="100px" height="100px" /></td>
