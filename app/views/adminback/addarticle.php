        ...
        <form role="form" action="postadd" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <labe>Title</label>
                    <input type="text" name="artTitle" class="form-control"  placeholder="Enter Title Name">
                  </div>
                  <!-- <div class="form-group">
                    <labe>AShortDesc</label>
                    <input type="text" name="artdec" class="form-control"  placeholder="Enter  Desc">
                  </div>   -->
                  <label for="exampleInputFile">Desc</label>
                  <textarea class="form-control textarea" name="artdec" placeholder="Enter  Desc"></textarea>
                  </div>
                  <div class="form-group">
